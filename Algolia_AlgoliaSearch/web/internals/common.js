requirejs(['algoliaBundle'], function(algoliaBundle) {
	algoliaBundle.$(function ($) {
		$(".ais-refinement-list--header.ais-header").click();
        $(".is-widget-container-manufacturer .ais-refinement-list--header.ais-header.close").click();
		...
		/*filter dropdown*/
		$(document).on('click', '.ais-refinement-list--header.ais-header', function () {
			$(this).toggleClass("close");
    		$(this).next().toggleClass("selection-close");
		});
		/** Handle small screen **/
		$('body').on('click', '#refine-toggle', function () {
			//$('#instant-search-facets-container').toggleClass('hidden-sm').toggleClass('hidden-xs');
			$('#instant-search-facets-container').toggleClass('top-100');			
			if ($(this).html()[0] === '+')
				$(this).html('- ' + algoliaConfig.translations.refine);
			else
				$(this).html('+ ' + algoliaConfig.translations.refine);
		});
		$('body').on('click', '.click-close-filter', function () {
			//$('#instant-search-facets-container').toggleClass('hidden-sm').toggleClass('hidden-xs');
			$('#instant-search-facets-container').toggleClass('top-100');
			$(".ais-refinement-list--header.ais-header").click();
            $(".is-widget-container-manufacturer .ais-refinement-list--header.ais-header.close").click();
